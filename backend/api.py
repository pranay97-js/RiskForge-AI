"""FastAPI Backend Service for RiskForge AI (Mobile & Cloud Risk Intelligence).

Exposes RESTful endpoints for:
1. Live Risk Telemetry & Spline Trendlines
2. Explainable AI (XAI) Drill-Down & SHAP Factor Attribution
3. Evidence & Automated Dispute Representment Engine
4. Interactive Cost-Optimization Matrix & Bayesian Threshold Sweeps
5. Merchant Actions (Biometric Challenge, Auto-Deflect, Accept Risk)
"""
...
def get_telemetry():
    ...
    # Pre-calculated telemetry metrics based on production validation
    return {
...
def execute_merchant_action(req: ActionRequest):
    ...
    record = {
        ...
        "action": req.action,
        "notes": req.analyst_notes or "Action triggered via ChargeGuard Mobile.",
        "timestamp": timestamp,
        "status": "EXECUTED",
    }
